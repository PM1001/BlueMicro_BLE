...
arduino_compile() {
   ...
   cmdCompile840="/arduino-cli compile -v --fqbn adafruit:nrf52:pca10056 --build-path $buildPath --build-cache-path $buildCachePath $sourcePath/firmware.ino  -o $buildPath/firmware"
